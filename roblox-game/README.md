...
| `lune run tools/smoothing-harness.luau` | Remote chefs render at true speed under jitter, loss, network and client stalls, a 500 ms outage, an out-of-order packet, a 1.5 s stall, a chef that resumes elsewhere, a bump, a 1 s server hitch, and the real send cadence |
