...
| `lune run tools/smoothing-harness.luau` | Remote chefs render at true speed under jitter, loss, network and client stalls, a 500 ms outage, an out-of-order packet, a server restart, and the real send cadence |
